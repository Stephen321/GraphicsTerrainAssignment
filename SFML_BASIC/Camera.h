...
public:
	...
	Camera() :forwardSpeed(0.5f), roationSpeed(0.1f), leftRightSpeed(0.5f), upDownSpeed(0.5f){}
    ...
    void MoveLeftRight(int dir){ //Dir=+1=>Right, dir=-1=> Left
		position.x += leftRightSpeed * dir;
    }

	void MoveUpDown(int dir){ //Dir=+1=>Right, dir=-1=> Left
		position.y += upDownSpeed * dir;
		//position+=(up*(upDownSpeed*dir)); 
    }
 
    void MoveForwardBack(int dir){ //Dir=+1=>Forward, dir=-1=> Back
		position.z += forwardSpeed * dir;
